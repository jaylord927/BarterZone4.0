...
public class trades_refund {
    ...
    public void loadTradesForRefundDropdown(JComboBox<String> refundTradeComboBox) {
        ...
        String sql = "SELECT t.trade_id, 'Trade #' || t.trade_id || ' - ' || u1.user_fullname || ' ↔ ' || u2.user_fullname as display "
                ...
                + "WHERE t.trade_status IN ('items_received', 'refund_pending', 'payment_verified') "
    ...
    public void loadTraderRefundData(int tradeId, int traderId, String traderName,
        ...
        if (!result.isEmpty()) {
            ...
            if (isRefunded == 1) {
                ...
                if (markButton != null) markButton.setEnabled(false);
            ...
            if (uploadButton != null) uploadButton.setEnabled(false);
            if (markButton != null) markButton.setEnabled(false);
            if (messageArea != null) messageArea.setText("");
            if (proofStatusLabel != null) proofStatusLabel.setText("No proof");
        }
    }
