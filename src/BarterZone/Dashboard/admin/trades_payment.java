...
public class trades_payment {
    ...
    public void loadPaymentVerificationData(int tradeId, int traderId, JLabel paymentNumberLabel,
            ...
            JButton markButton, int[] paymentIdHolder, JLabel proofInfoLabel) {
        ...
        if (!result.isEmpty()) {
            ...
            // Set payment number and account name - full text, no truncation
            ...
            // Set proof info label
            if (proofInfoLabel != null) {
                if (!proofPath.isEmpty()) {
                    proofInfoLabel.setText("✓ Payment proof attached");
                    proofInfoLabel.setForeground(new Color(46, 125, 50));
                } else {
                    proofInfoLabel.setText("✗ No payment proof uploaded");
                    proofInfoLabel.setForeground(new Color(204, 0, 0));
                }
            }
            ...
            markButton.setEnabled(false);
            if (proofInfoLabel != null) {
                proofInfoLabel.setText("✗ No payment record found");
                proofInfoLabel.setForeground(new Color(204, 0, 0));
            }
            if (paymentIdHolder != null && paymentIdHolder.length > 0) {
                paymentIdHolder[0] = -1;
