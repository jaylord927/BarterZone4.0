...
public class add_items extends javax.swing.JFrame {
    ...
    public add_items(int traderId, String traderName) {
    ...
    private void initComponents() {
        ...
        javax.swing.JLabel titleLabel = new javax.swing.JLabel("ADD NEW ITEM");
        ...
        btnSave = new javax.swing.JButton("ADD ITEM");
    ...
    private void displayImagePreview(String imagePath) {
        try {
            ...
            java.awt.Image image = icon.getImage().getScaledInstance(140, 140, java.awt.Image.SCALE_SMOOTH);
